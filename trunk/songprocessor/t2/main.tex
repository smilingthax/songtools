...
\newcommand\refr[1]{{\reff\myl{Refr:\ }{#1}}}
\newcommand\vers[2][\thevers]{\setcounter{vers}{#1}\myl{\thevers.\ \ }{#2}\addtocounter{vers}{1}}
\newcommand\bridge[1]{\myl{Bridge:\ }{#1}}
\newcommand\finally[1]{\myl{Schluss:\ }{#1}}
\newcommand\xlate[1]{(Übersetzung: #1)}
